        ...
        <div class="w-full pr-2 lg:w-1/4 lg:block">
            ...
            <ul>
              ...
              <li class="mb-4" wire:key ="{{ $category->id }}" >
                <label for="{{ $category->slug }}" class="flex items-center dark:text-gray-400 ">
                  <input type="checkbox" class="w-4 h-4 mr-2" wire:model.live="selected_categories" id="{{ $category->slug }}" value="{{ $category->id }}">
            ...
            <ul>
              ...
              <li class="mb-4" wire:key ="{{ $brand->id }}">
                <label for="{{ $brand->slug }}" class="flex items-center dark:text-gray-300">
                  <input type="checkbox" class="w-4 h-4 mr-2" wire:model.live="selected_brands" id="{{ $brand->slug }}" value="{{ $brand->id }}">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div>
              ...
              <input type="range" wire:model.live="price_range" id="on_sale" value="1" class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="500000" value="300000" step="1000">
            ...
            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key ="{{ $product->id }}"> 
              <div class="border border-gray-300 dark:border-gray-700">
                ...
                <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                  ...
                  <a wire:navigate wire:click.prevent= 'addToCart({{ $product->id }})' href="#" class="text-gray-500 flex items-center space-x-2 dark:text-gray-400 hover:text-red-500 dark:hover:text-red-300">
