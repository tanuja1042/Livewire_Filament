  ...
  <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
    <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ asset('storage/' . $productData->images[0] ) }}' }">
          <div class="sticky top-0 z-50 overflow-hidden ">
            ...
            <div class="flex-wrap hidden md:flex ">
              ...
              <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{ asset('storage/' . $images ) }}'">
                <img src="{{ asset('storage/' . $images ) }}" alt="" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
              </div>
              @endforeach
          ...
          <div class="lg:pl-20">
            <div class="mb-8 ">
              ...
              <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                <span>$1500.99</span>
                <span class="text-base font-normal text-gray-500 line-through dark:text-gray-400">{{ Number::currency($productData->price,'INR') }}</span>
              </p>
            ...
            <div class="flex flex-wrap items-center gap-4">
              <button wire:click= 'addToCart({{ $productData->id }})' class="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
                <span wire:loading.remove wire:target='addToCart({{ $productData->id }})'>Add to cart</span><span wire:loading wire:target='addToCart({{ $productData->id }})'>Adding...</span></button>
            </div>
          </div>
        </div>
      </div>
