        ...
        <div class="p-4 sm:p-7">
          ...
          <div class="mt-5">
            ...
            <form wire:submit.prevent='save'>
              @if(session('success'))
                <div class="mt-2 bg-green-100 border border-green-200 text-sm text-green-800 rounded-lg p-4 dark:bg-green-800/10 dark:border-green-900 dark:text-green-500 mb-4" role="alert" tabindex="-1" aria-labelledby="hs-soft-color-danger-label">
                {{ session('success') }}
              </div>
              @endif
